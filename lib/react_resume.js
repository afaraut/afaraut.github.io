    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "li",
          null,
          React.createElement("a", { className: "fa fa-linkedin-square fa-2x", href: profile.profiles[0].url, target: "_blank" })
        ),
        React.createElement(
          "li",
          null,
          React.createElement("a", { className: "fa fa-github fa-2x", href: profile.profiles[1].url, target: "_blank" })
        ),
        React.createElement(
          "li",
          null,
          React.createElement("a", { className: "fa fa-stack-overflow fa-2x", href: profile.profiles[2].url, target: "_blank" })
        ),
        React.createElement(
          "li",
          null,
          React.createElement("a", { className: "fa fa-skype fa-2x", href: profile.profiles[3].url, target: "_blank" })
        ),
        React.createElement(
          "li",
          null,
          React.createElement("a", { className: "fa fa-file-pdf-o fa-2x", href: profile.profiles[4].url, target: "_blank" })
        )
      ),
      React.createElement("div", { className: "divider" }),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            this.props.workItemData.website
          ),
          " / ",
...
React.render(React.createElement(Resume, { data: data, language: language }), document.getElementById('reactjson'));