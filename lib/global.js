  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("img", { src: "images/flags/fr.svg", className: "drap", alt: "fr_FR" })
      ),
      React.createElement(
        "a",
        { href: "javascript:void(0)", onClick: this.props.handleClick_en },
        React.createElement("img", { src: "images/flags/us_uk.svg", className: "drap", alt: "en_US" })
      ),
      React.createElement(
        "a",
        { href: "javascript:void(0)", onClick: this.props.handleClick_de },
        React.createElement("img", { src: "images/flags/de.svg", className: "drap", alt: "de_DE" })
      )
    );
  }
});
...
var Profile = React.createClass({
  ...
  getProfileDetails: function getProfileDetails() {
    ...
    return React.createElement(
      ...
      React.createElement(Langue, { handleClick_en: this.props.handleClick_en, handleClick_de: this.props.handleClick_de, handleClick_fr: this.props.handleClick_fr }),
