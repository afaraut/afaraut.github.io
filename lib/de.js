var de = {
  "basics": {
    ...
    "information": "I built this site with <a href='https://facebook.github.io/react/' target='_blank'>React</a> components and a <a href='https://jsonresume.org/schema/' target='_blank'>JSON Resume Schema</a> which I modified for my needs. The full source code can be found in <a href='https://github.com/afaraut/afaraut.github.io' target='_blank'>my Github repo</a>.",
    "location": {
  ...
  "interests": {
    ...
    "items": [{
      ...
      "name": "Sports",
      "keywords": ["Running", "Cycling", "Rafting", "Canyoning", "Basketball (3 years) - County Champion", "Karate (3 years)", "Sailing"]
    }, {
      "name": "Heimwerker",
